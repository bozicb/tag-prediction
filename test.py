...
m1=pd.read_csv('method1_content.csv')
m1b=pd.read_csv('method1_content+books.csv')
m2=pd.read_csv('method2.csv')
m3=pd.read_csv('method3_content.csv')
m3b=pd.read_csv('method3_content+books.csv')
m41=pd.read_csv('method4_content_k1.csv')
m4b1=pd.read_csv('method4_content+books_k1.csv')
m42=pd.read_csv('method4_content_k2.csv')
m4b2=pd.read_csv('method4_content+books_k2.csv')
m43=pd.read_csv('method4_content_k3.csv')
m4b3=pd.read_csv('method4_content+books_k3.csv')
m44=pd.read_csv('method4_content_k4.csv')
m4b4=pd.read_csv('method4_content+books_k4.csv')
m45=pd.read_csv('method4_content_k5.csv')
m4b5=pd.read_csv('method4_content+books_k5.csv')
#performance(df)
recall(df)
